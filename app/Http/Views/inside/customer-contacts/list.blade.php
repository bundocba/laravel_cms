...
<?php $title = !$isTrash ? 'Banner - Danh sách liên hệ' : 'Danh sách liên hệ - Danh sách thùng rác'; ?>
...
<section class="content">
    <div class="box box-primary">
        <div class="box-body" id="b-l-list">
            ...
            @if (Session::has('customer-contacts-inactive-success-message'))
            <div class="alert alert-info alert-dismissable">
                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                <h4><i class="icon fa fa-check"></i> Thành công!</h4>
                {{ Session::get('customer-contacts-inactive-success-message') }}
            </div>
            @elseif (Session::has('customer-contacts-inactive-error-message'))
            <div class="alert alert-danger alert-dismissable">
                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                <h4><i class="icon fa fa-ban"></i> Lỗi!</h4>
                {{ Session::get('customer-contacts-inactive-error-message') }}
            </div>
            @endif
            ...
            <div class="btn-wrapper col-xs-12">
                <div class="btn-group pull-right">
                    ...
                    <a href="{!! route('admin.customer-contacts.getAdd') !!}">
                    ...
                    <?php $route = $isTrash ? 'admin.customer-contacts.getList' : 'admin.customer-contacts.getTrash'; ?>
            ...
            <table class="table table-striped table-hover table-bordered" id="edt" lang="vi" >
                ...
                <tbody class="table-content">
                    ...
                    <tr class="table-tr">
                        ...
                        <td class="table-td">
                            <p>{!! str_limit(strip_tags($row['company_name']), 50) !!}</p>
                        </td>
                        <td class="table-td">
                            <p>{!! str_limit(strip_tags($row['full_name']), 50) !!}</p>
                        </td>
                        ...
                        <td class="table-td">
                            <p>
                                @if ($row['is_deleted'] && isset($myPermission['admin.customer-contacts.undo']))
                                <a href="{!! route('admin.customer-contacts.undo', $row['id']) !!}" class="btn btn-primary tooltips btn-xs" data-placement="top" data-original-title="Kích hoạt lại">
                                    <i class="fa fa-undo"></i>
                                </a>
                                @else

                                @if (isset($myPermission['admin.customer-contacts.getEdit']))
                                <a href="{!! route('admin.customer-contacts.getEdit', $row['id']) !!}" class="btn btn-primary tooltips btn-xs" data-placement="top" data-original-title="Sửa">
                                    <i class="fa fa-pencil"></i>
                                </a>
                                @endif

                                @if (isset($myPermission['admin.customer-contacts.inactive']))
                                <a href="{!! route('admin.customer-contacts.inactive', $row['id']) !!}" class="btn btn-danger tooltips btn-xs" data-placement="top" data-original-title="Khóa">
