...
@section('title', 'Thành viên - Thêm thành viên')
...
<section class="content">
    <div class="box box-info">
        ...
        {!! Form::open(['url' => 'admin/users/add', 'method' => 'POST', 'id' => 'user-add-form', 'class' => 'form-horizontal']) !!}

        <div class="box-body">

            @if (Session::has('user-add-success-message'))
            <div class="alert alert-info alert-dismissable">
                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                <h4><i class="icon fa fa-check"></i> Thành công!</h4>
                {{ Session::get('user-add-success-message') }}
            </div>
            @elseif (Session::has('user-add-error-message'))
            <div class="alert alert-danger alert-dismissable">
                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                <h4><i class="icon fa fa-ban"></i> Lỗi!</h4>
                {{ Session::get('user-add-error-message') }}
            </div>
            @endif
            ...
            <div class="form-group has-feedback {{ ($errors->has('password') ? 'has-error' : '') }}">
                <div class="col-sm-2 control-label">
                    {!! Form::label('password', 'Mật khẩu', ['class' => '']) !!} <span class="required">*</span>
                </div>            
                <div class="col-sm-10">
            ...
            <div class="form-group has-feedback {{ ($errors->has('repeat_password') ? 'has-error' : '') }}">
                <div class="col-sm-2 control-label">
                    {!! Form::label('repeat_password', 'Nhập lại mật khẩu', ['class' => '']) !!} <span class="required">*</span>
                </div>
                <div class="col-sm-10">
                    {!! Form::password('repeat_password', ['placeholder' => 'Nhập lại mật khẩu', 'name' => 'repeat_password', 'class' => 'form-control']) !!}
                    <span class="glyphicon glyphicon-lock form-control-feedback"></span>
                    @if ($errors->has('repeat_password'))
                    <div class="error-messages">{{ $errors->first('repeat_password') }}</div>
                    @endif
                </div>
            </div>
