...
@section('title', 'Banner - Thêm banner')
...
<section class="content">
    <div class="box box-info">
        ...
        {!! Form::open(['url' => 'admin/banners/add', 'method' => 'POST', 'id' => 'banner-add-form', 'class' => 'form-horizontal']) !!}

        <div class="box-body">

            @if (Session::has('banner-add-success-message'))
            <div class="alert alert-info alert-dismissable">
                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                <h4><i class="icon fa fa-check"></i> Thành công!</h4>
                {{ Session::get('banner-add-success-message') }}
            </div>
            @elseif (Session::has('banner-add-error-message'))
            <div class="alert alert-danger alert-dismissable">
                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                <h4><i class="icon fa fa-ban"></i> Lỗi!</h4>
                {{ Session::get('banner-add-error-message') }}
            </div>
            @endif
