...
@section('title', 'Thể loai - Sửa thông tin thể loại')
...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Sửa thông tin thể loại</li>
    </ol>
</section>
<section class="content">
    <div class="box box-info">

        {!! Form::model($postCategory + $postCategoryLanguage, ['route' => ['admin.post-categories.postEdit', $postCategory['id']], 'method' => 'POST', 'id' => 'post-category-edit-form', 'class' => 'form-horizontal']) !!}

        <div class="box-body">

            @if (Session::has('post-category-edit-success-message'))
            <div class="alert alert-info alert-dismissable">
                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                <h4><i class="icon fa fa-check"></i> Thành công!</h4>
                {{ Session::get('post-category-edit-success-message') }}
            </div>
            @elseif (Session::has('post-category-edit-error-message'))
            <div class="alert alert-danger alert-dismissable">
                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                <h4><i class="icon fa fa-ban"></i> Lỗi!</h4>
                {{ Session::get('post-category-edit-error-message') }}
            </div>
            @endif
