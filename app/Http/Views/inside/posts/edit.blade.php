...
@section('title', 'Bài viết - Sửa thông tin bài viết')
...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Sửa thông tin bài viết</li>
    </ol>
</section>
<section class="content">
    <div class="box box-info">

        {!! Form::model($post + $postLanguage, ['route' => ['admin.posts.postEdit', $post['id']], 'method' => 'POST', 'id' => 'post-edit-form', 'class' => 'form-horizontal']) !!}

        <div class="box-body">

            @if (Session::has('post-edit-success-message'))
            <div class="alert alert-info alert-dismissable">
                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                <h4><i class="icon fa fa-check"></i> Thành công!</h4>
                {{ Session::get('post-edit-success-message') }}
            </div>
            @elseif (Session::has('post-edit-error-message'))
            <div class="alert alert-danger alert-dismissable">
                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                <h4><i class="icon fa fa-ban"></i> Lỗi!</h4>
                {{ Session::get('post-edit-error-message') }}
            </div>
            @endif
                ...
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        ...
                        <li class="{{ $id == 1 ? 'active' : '' }}">
                            <?php
                            $errorIcon = '&nbsp;&nbsp;<img class="error-alert-icon" src="' . asset('public/inside/img/system/error_alert_icon.png') . '" />';
                            ?>
            ...
            <div class="form-group last p-l-thumbnail {{ ($errors->has('image_name') ? 'has-error' : '') }}">
                ...
                <div class="col-md-10">
                    <?php
                    $img = empty(Input::old('image_name')) ? $post['image_name'] : Input::old('image_name');
